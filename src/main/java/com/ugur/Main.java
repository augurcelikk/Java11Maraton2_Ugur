...
public class Main {
        ...
        do {
            ...
            switch(secim){
                case 1:
                    ...
                    break;
                case 2:{
                    Optional<User> user=userController.girisYap();
                    if (user.isPresent()){
                        userMenu(user.get());
                    }
                    break;
    ...
    private void userMenu(User user) {
        ...
        do {
            ...
            switch (secim){
                case 1 : {
                    computerSpecController.bilgisayarBileseniOlustur();
                    break;
                }
                case 2:
                    computerController.bilgisayarOlustur(user);
                    break;
                case 3:
                    postController.postOlustur(user);
                    break;
                case 4:
                    likeController.begeniYap(user);
                    break;
                case 5:
                ...
                case 6:
                    ...
                    break;
                case 7:
                    postController.birKisiyeAitPostlar(user.getId()).forEach(System.out::println);
                    break;
                case 0:{
